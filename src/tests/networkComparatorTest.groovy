...
class networkComparatorTest extends GroovyTestCase {
    ...
    void test3() {
        def ideal = new netTemplate()
        def tocompare = new netTemplate()
        ideal.addConnection("raul", "ana", "October 2012","","")
        tocompare.addConnection("ana", "raul", "November 2013","","")
...
//            jack : 33 + 33 + 0 = 66
            def ideal = new netTemplate()
            def tocompare = new netTemplate()
            ideal.addConnection("mary","john","","","")
            ideal.addConnection("john","gary","","","")
            ideal.addConnection("gary","mark","2009","","")
            ideal.addConnection("mark","rose","2003","","")
            ideal.addConnection("rose","jack", "july","","")

            tocompare.addNode("john")
            tocompare.addConnection("gary","mark","","","")
            tocompare.addConnection("mark","rose","2003","","")
            tocompare.addConnection("jack","rose", "2009","","")
